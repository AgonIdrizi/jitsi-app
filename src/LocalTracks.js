...
class LocalTracks extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    const micIsMuted = componentGetCompareProps(
      "micIsMuted",
      this.state,
      prevState,
      ""
    ...
    const videoIsMuted = componentGetCompareProps(
      "videoIsMuted",
      this.state,
      prevState,
      ""
  ...
  render() {
    ...
    return (
      <div className="local_track">
        ...
        <button
          onClick={() => this.setState({ micIsMuted: !this.state.micIsMuted })}
        >
          {this.state.micIsMuted ? "sound muted" : " sound unmuted"}
        </button>
        <button
          onClick={() =>
        ...
        >
          {this.state.videoIsMuted ? "video muted" : "video unmuted"}
        </button>
      </div>
    );
  }
